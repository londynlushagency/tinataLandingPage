...
export default function Example({ subheading, heading }: { subheading?: string, heading?: string }) {
    return (
        <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-gray-900">
            ...
            <div className="mx-auto max-w-4xl text-center">
                <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">{subheading || "Subheading"}</h2>
